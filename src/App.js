  ...
  return (
    <>
      <div className="bg-white dark:bg-[#1B1B1B] transition duration-500 ease-in-out flex flex-col font-inter">
        ...
        <div className="flex flex-col p-5 items-center justify-around h-[80vh] w-[20%] border dark:border-gray-600 border-gray-200 rounded-3xl fixed left-10 block top-[50%] translate-x-[10%] translate-y-[-50%] dark:text-white">
          <div>Web Developer</div>
          <div className="w-[90%] flex justify-center items-center h-[40%] rounded-3xl overflow-hidden">
            <img src={photo}></img>
          </div>
          <div className="text-lg font-[300]">nepalroman100@gmail.com</div>
          <div className="text-sm text-gray-500">
            © 2022 Roman. All Rights Reserved
          </div>
          <div className="flex w-[80%] justify-between">
            <a href="https://www.facebook.com/roman.nepal.1">
              <div className="border border-gray-400 rounded-full p-3 hover:border-[#28E98C] fill-gray-400 hover:fill-[#28E98C]">
                <svg
          ...
          <div className="w-full">
            <button className="w-full flex items-center justify-center gap-2 bg-[#28E98C] dark:text-black text-white  dark:hover:text-[#28E98C] hover:bg-[#1B1B1B] border-2 border-[#28E98C] px-4 py-3 rounded-full transition ease-in">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div
          className="ml-[33%] mr-[20%] h-[140vh] flex flex-col"
          id="section1"
        >
          <Introduction />
        </div>
        <div
          className="ml-[33%] mr-[20%] h-[100vh] flex flex-col"
          id="section2"
        >
          <About />
        </div>
